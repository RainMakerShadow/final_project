            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <input wire:loading.attr="disabled" wire:loading.attr="disabled" wire:model="img_descr" type="text" id="img_descr" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required value="{{$product_category->img_title}}">
                        @error('title') <span class="error text-red-500">{{ $message }}</span> @enderror
                    </div>
                    <div class="mb-6">
