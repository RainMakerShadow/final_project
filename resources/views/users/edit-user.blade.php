        ...
        <form wire:submit.prevent="submit" enctype="multipart/form-data">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2 ">
                ...
                <div class="grid justify-items-center">
                    @if (is_object($image))
                        <img class="h-auto max-w-xl rounded-lg shadow-xl shadow-gray-700 dark:shadow-white-700" src= "{{$image->temporaryUrl()}}"  alt="" width="50%">
                    @else
                        <img class="h-auto max-w-xl rounded-lg shadow-xl shadow-gray-700 dark:shadow-white-700" src= "{{$imageUrl}}"  alt="" width="50%">
                    @endif
                </div>
            </div>
