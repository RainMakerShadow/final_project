        ...
        <div class="flex items-center justify-between pb-4 bg-white dark:bg-gray-900">
            <div>
                ...
                <div id="dropdownAction" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                    ...
                    <div class="py-1">
                        <a href="{{route('user.delete', [implode(',', $toDelete)])}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Видалити товар</a>
                    </div>
                </div>
            </div>
...
{{--                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownActionButton">--}}
{{--                    <li>--}}
{{--                        <a href="{{route('user.add')}}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Додати</a>--}}
{{--                    </li>--}}
{{--                    <li>--}}
...
{{--                    <div class="pl-3">--}}
{{--                        <div class="text-base font-semibold">{{$product->img}}</div>--}}
{{--                        <div class="font-normal text-gray-500">{{$product->img_title}}</div>--}}
{{--                    </div>--}}
{{--                </td>--}}
{{--                <td scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">--}}
{{--                    <div class="text-base font-semibold">{{$product->title}}</div>--}}
...
{{--                </td>--}}
{{--                <td class="px-6 py-4">--}}
{{--                    <a href="{{route('user.edit',['id'=>$product->id])}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Редагувати</a>--}}
{{--                </td>--}}
{{--            </tr>--}}
{{--        @endforeach--}}
