        ...
        <div>
            ...
            <div id="dropdownAction" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownActionButton">
                    <li>
                        <a href="{{route('menu.add')}}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white hover:rounded">Додати пункт меню</a>
                    </li>
                </ul>
                <div class="py-1">
                    <a href="{{route('menu.delete', [implode(',', $toDelete)])}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100  hover:rounded dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Видалити пункт меню</a>
                </div>
            </div>
        </div>
